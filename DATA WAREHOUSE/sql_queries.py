...
# STAGING TABLES
# Copies the data from the S3 bucket address in the dwh.cfg file, and loads them into staging_events and staging_songs
staging_events_copy = ("""
...
# FINAL TABLES
# Inserts the values into the dimensional tables from staging_events and staging_songs
