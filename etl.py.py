...
def process_log_file(cur, filepath):
    ...
    It filters the file with only the 'NextSong' action.
    ...
    Then it extracts the song play information with inner joined data from song, artist tables. The data is store into the song play table.
...
def process_data(cur, conn, filepath, func):
    ...
    '''
    This procedure runs a for loop to process all the files from the folder filepath with the function passed in
    
    INPUTS: 
    * cur the cursor variable
    * conn the database connection
    * filepath the file path to the song/log files
    * func the function that is passed in
    '''
